...
namespace CustomerManager.Repository
{
    internal static class DataInitializer
    {
        ...
        {
            new Camera{Description = "cam1", Url = "google.com", Id = 1},
            new Camera{Description = "cam2", Url = "google.com", Id = 2},
            new Camera{Description = "cam3", Url = "google.com", Id = 3},
            new Camera{Description = "cam4", Url = "google.com", Id = 4}
        };
    }
}
